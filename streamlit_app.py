    ...
    with subtab_m:
        ...
        with st.expander("📋 Detailed table — click to expand for in-depth review", expanded=False):
            ...
            if tr_m_show:
                ...
                st.dataframe(_color_m(df_m_tbl), use_container_width=True, hide_index=True,
                             height=min(500, 42+35*len(df_m_tbl)),
    ...
    with subtab_y:
        ...
        with st.expander("📋 Detailed table — click to expand for in-depth review", expanded=False):
            ...
            if tr_y_filt:
                ...
                st.dataframe(_color_y(df_y_tbl), use_container_width=True, hide_index=True,
                             height=min(500, 42+35*len(df_y_tbl)),
                             column_config={"ℹ️": st.column_config.TextColumn("ℹ️", width=40,
                                            help="Hover to see note")})
