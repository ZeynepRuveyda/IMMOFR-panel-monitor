...
MARKET_CONFIG = {
    "🏠 IMMOFR":   {"key":"IMMOFR",   "label":"IMMO FR",   "sites":IMMOFR_SITES,  "file_roles":FILE_ROLES,         "group_info":GROUP_INFO,         "classify_fn":None,      "run_checks_fn":None,      "has_special_check":True,  "has_dept_region":True},
    "🚗 AUTOFR":   {"key":"AUTOFR",   "label":"AUTO FR",   "sites":AUTOFR_SITES,  "file_roles":FILE_ROLES_AUTOFR,  "group_info":GROUP_INFO_AUTOFR,  "classify_fn":"autofr",  "run_checks_fn":"autofr",  "has_special_check":False, "has_dept_region":False},
    "🏠 IMMOUK":   {"key":"IMMOUK",   "label":"IMMO UK",   "sites":["Rightmove","Zoopla","OnTheMarket","Primelocation","Boomin"],   "file_roles":{"file1":"1 — Panel evolution","file2":"2 — Quality metrics","file3":"3 — Professionals"},   "group_info":{"1":("Panel evolution","Volumes"),"2":("Quality metrics","Freshness"),"3":("Professionals","Pro counts")}, "classify_fn":"generic","run_checks_fn":"generic","has_special_check":False,"has_dept_region":False},
    "🏠 IMMODE":   {"key":"IMMODE",   "label":"IMMO DE",   "sites":["ImmoScout24","Immowelt","Immonet","eBay Kleinanzeigen","Engel & Völkers"],           "file_roles":{"file1":"1 — Panel evolution","file2":"2 — Quality metrics"},                                          "group_info":{"1":("Panel evolution","Volumes"),"2":("Quality metrics","Freshness")},                                    "classify_fn":"generic","run_checks_fn":"generic","has_special_check":False,"has_dept_region":False},
    "🚗 AUTOUK":   {"key":"AUTOUK",   "label":"AUTO UK",   "sites":["AutoTrader","Motors","CarGurus","Cazoo","Arnold Clark"],                              "file_roles":{"file1":"1 — Panel evolution","file2":"2 — Performance"},                                               "group_info":{"1":("Panel evolution","Volumes"),"2":("Performance","Freshness")},                                        "classify_fn":"generic","run_checks_fn":"generic","has_special_check":False,"has_dept_region":False},
    "📰 EMPLOIFR": {"key":"EMPLOIFR", "label":"EMPLOI FR", "sites":["Indeed","LinkedIn","Pôle Emploi","Monster","Cadremploi"],                             "file_roles":{"file1":"1 — Panel evolution","file2":"2 — Quality metrics"},                                          "group_info":{"1":("Panel evolution","Volumes"),"2":("Quality metrics","Freshness")},                                    "classify_fn":"generic","run_checks_fn":"generic","has_special_check":False,"has_dept_region":False},
    "🚛 TRUCKSFR": {"key":"TRUCKSFR", "label":"TRUCKS FR", "sites":["Leboncoin","ParuVendu","Truck1","Truckscout24","Mascus"],                             "file_roles":{"file1":"1 — Panel evolution","file2":"2 — Quality metrics"},                                          "group_info":{"1":("Panel evolution","Volumes"),"2":("Quality metrics","Freshness")},                                    "classify_fn":"generic","run_checks_fn":"generic","has_special_check":False,"has_dept_region":False},
    "🚗 AUTOBR":   {"key":"AUTOBR",   "label":"AUTO BR",   "sites":["OLX","Webmotors","iCarros","AutoLine","Mercado Livre"],                               "file_roles":{"file1":"1 — Panel evolution","file2":"2 — Quality metrics"},                                          "group_info":{"1":("Panel evolution","Volumes"),"2":("Quality metrics","Freshness")},                                    "classify_fn":"generic","run_checks_fn":"generic","has_special_check":False,"has_dept_region":False},
    "🏠 NPV":      {"key":"NPV",      "label":"NPV UK",    "sites":["Rightmove","Zoopla","OnTheMarket","Primelocation"],                                  "file_roles":{"file1":"1 — Panel evolution","file2":"2 — Quality metrics","file3":"3 — New builds"},                    "group_info":{"1":("Panel evolution","Volumes"),"2":("Quality metrics","Freshness"),"3":("New builds","NPV checks")},    "classify_fn":"generic","run_checks_fn":"generic","has_special_check":False,"has_dept_region":False},
}
...
# ── market_cfg must be resolved before sidebar ──
_mc_key = st.session_state.get("market_choice", "🏠 IMMOFR")
# Lookup by full key or by market key (without emoji)
market_cfg = (
    MARKET_CONFIG.get(_mc_key)
    or next((v for v in MARKET_CONFIG.values() if v["key"] == _mc_key), None)
    or MARKET_CONFIG["🏠 IMMOFR"]
)
