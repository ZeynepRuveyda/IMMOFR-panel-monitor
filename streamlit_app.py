...
with tab2:
    ...
    def _trend_table_html(rows, title="All series — M/M-1", cols_extra=None):
        ...
        html_out = f"""
<style>
.trtbl {{width:100%;border-collapse:collapse;font-size:13px;font-family:sans-serif}}
.trtbl th {{text-align:left;padding:6px 8px;border-bottom:2px solid #ddd;color:#666;font-weight:500;white-space:nowrap}}
.trtbl td {{padding:5px 8px;border-bottom:1px solid #f0f0f0;vertical-align:middle;white-space:nowrap}}
.trtbl tr:hover td {{background:rgba(0,0,0,0.02)}}
.nt {{cursor:help;color:#e07b00;border-bottom:1px dashed #e07b00;font-size:12px;position:relative}}
.nt::after {{
