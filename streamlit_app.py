...
MARKET_CONFIG = {
    ...
    "AUTOUK":   {"key":"AUTOUK",   "label":"AUTO UK",   "emoji":"🚗", "sites":[], "file_roles":{}, "group_info":{}, "classify_fn":"generic","run_checks_fn":"generic","has_special_check":False,"has_dept_region":False},
    "EMPLOIFR": {"key":"EMPLOIFR", "label":"EMPLOI FR", "emoji":"📰", "sites":[], "file_roles":{}, "group_info":{}, "classify_fn":"generic","run_checks_fn":"generic","has_special_check":False,"has_dept_region":False},
    "TRUCKSFR": {"key":"TRUCKSFR", "label":"TRUCKS FR", "emoji":"🚛", "sites":[], "file_roles":{}, "group_info":{}, "classify_fn":"generic","run_checks_fn":"generic","has_special_check":False,"has_dept_region":False},
    "AUTOBR":   {"key":"AUTOBR",   "label":"AUTO BR",   "emoji":"🚗", "sites":[], "file_roles":{}, "group_info":{}, "classify_fn":"generic","run_checks_fn":"generic","has_special_check":False,"has_dept_region":False},
    "NPV":      {"key":"NPV",      "label":"NPV UK",    "emoji":"🏠", "sites":[], "file_roles":{}, "group_info":{}, "classify_fn":"generic","run_checks_fn":"generic","has_special_check":False,"has_dept_region":False},
