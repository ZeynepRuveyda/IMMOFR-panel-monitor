...
def load_wb_any(data):
    """Load workbook from bytes — supports both .xlsx and .xls (OLE)"""
    try:
        ...
        try:
            ...
            # Convert to openpyxl-like object via in-memory xlsx
            import tempfile, os
...
""")
    ...
    if "file1" in fb:
        try:
            ...
            wb1 = load_workbook(io.BytesIO(_fb_bytes), data_only=True)
            ...
            if ws_tot:
                # Try standard read_series first
